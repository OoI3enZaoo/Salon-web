    ...
    <div id="app">
        <div class="container">
            <div class="__cov-video-container" @mouseenter="mouseEnterVideo" @mouseleave="mouseLeaveVideo">
                <video :class="{ 'hide-cursor': !state.contrlShow }" :src="'http://172.104.189.169:4400/api/getfile/' + videoname" class="__cov-video" :poster="options.poster">
...
export default {
    ...
    methods: {
        ...
        play () {
          console.log('hello')
          // this.sources[0].src = 'http://localhost:4000/api/getfile/' + this.$store.getters.lessonFromId(this.lessonId)[0].video
